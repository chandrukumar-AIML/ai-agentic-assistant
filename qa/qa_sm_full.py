# -*- coding: utf-8 -*-
"""SM Full Feature QA — 37 core actions | Kavitha Nair / Brand: SpiceRoute Teas persona"""
...
# 1
sm("generate", {"topic": "Monsoon is the perfect time for our Masala Chai", "platform": "instagram", "tone": "warm", "brand": BRAND}, "content")
# 2
...
# 6
sm("competitor_audit", {"competitor_brand": "Chaayos", "our_brand": BRAND, "industry": INDUSTRY}, "analysis")
# 7
sm("ad_copy", {"product": "SpiceRoute Premium Masala Chai", "platform": "instagram", "target_audience": "health-conscious urban Indians 25-40", "usp": "100% natural, no preservatives"}, "headlines")
# 8
...
# 11
sm("email_sequence", {"brand": BRAND, "campaign_goal": "welcome new subscribers", "emails": 3, "product": "Starter Tea Kit"}, "emails")
# 12
sm("reel_script", {"brand": BRAND, "topic": "Morning ritual with SpiceRoute Masala Chai", "duration_seconds": 30}, "script")
# 13
...
# 14
sm("keyword_cluster", {"topic": "Indian tea brands", "industry": INDUSTRY}, "clusters")
# 15
sm("best_post_time", {"platform": "instagram", "industry": INDUSTRY, "target_audience": "urban Indian millennials"}, "recommendations")
# 16
sm("benchmark_engagement", {"platform": "instagram", "industry": INDUSTRY, "our_engagement_rate": 4.2}, "benchmark")
# 17
sm("performance_score", {"platform": "instagram", "content": "Our Masala Chai is made with 6 hand-picked spices", "hashtags": "#masalachai #indiantea", "posting_time": "8 AM IST"}, "score")
# 18
...
# 20
sm("whatsapp_content", {"brand": BRAND, "content_type": "broadcast", "product": "Monsoon Chai Kit", "offer": "20% off"}, "message")
# 21
...
# 23
sm("content_pillars", {"brand": BRAND, "industry": INDUSTRY, "target_audience": "health-conscious millennials"}, "pillars")
# 24
sm("brand_monitor", {"brand": BRAND, "competitors": ["Chaayos", "Tea Trunk"], "industry": INDUSTRY}, "summary")
# 25
sm("competitor_tracker", {"competitor": "Chaayos", "our_brand": BRAND, "platform": "instagram"}, "analysis")
# 26
...
# 27
sm("festive_post", {"brand": BRAND, "festival": "Onam", "product": "Kerala Special Tea Pack", "platform": "instagram"}, "post")
# 28
sm("twitter_thread", {"brand": BRAND, "topic": "Why Indian chai is better than coffee for productivity", "tweets": 5}, "thread")
# 29
sm("story_highlights", {"brand": BRAND, "categories": ["Products", "Reviews", "Behind the Scenes", "Recipes"]}, "highlights")
# 30
sm("meme_caption", {"brand": BRAND, "meme_type": "relatable", "context": "Monday morning without chai"}, "caption")
# 31
sm("bio_optimizer", {"brand": BRAND, "platform": "instagram", "usp": "Premium hand-crafted Indian teas", "target_audience": "tea lovers"}, "bio")
# 32
sm("product_launch_kit", {"brand": BRAND, "product": "SpiceRoute Winter Blend", "launch_date": "October 2026", "budget": "₹1L"}, "kit")
# 33
...
# 34
sm("linkedin_article", {"brand": BRAND, "topic": "Building a D2C tea brand in India — lessons from our first year", "word_count": 600}, "article")
# 35
sm("review_testimonial_kit", {"brand": BRAND, "product": "Masala Chai Box", "reviews": [{"text": "Best chai I've had!", "rating": 5}, {"text": "Very authentic taste", "rating": 4}]}, "kit")
# 36
sm("ab_copy_test", {"brand": BRAND, "product": "Monsoon Chai Kit", "platform": "instagram", "variants": 2, "goal": "conversions"}, "variants")
# 37
sm("social_roi", {"brand": BRAND, "platform": "instagram", "period": "Q2 FY26", "ad_spend": 50000, "revenue_attributed": 180000, "new_followers": 1200, "total_posts": 28}, "roi")
...
total   = len(results)
print(f"  RESULTS: {passed}/{total} PASS | {partial} PARTIAL | {failed} FAIL")
if failed:
    print(f"\n  FAILURES:")
