# FIXED: Removed duplicate Phase A auth code — Phase H is canonical
import logging
...
from backend.auth.models import UserRole, PlanTier, JWTClaims, TokenResponse

# SlowAPI rate limiter (shared across all routes)
