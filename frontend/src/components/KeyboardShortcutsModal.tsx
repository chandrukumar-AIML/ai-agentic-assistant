// FIXED: Created correctly-spelled file to match App.tsx import of `KeyboardShortcutsModal`
// (Original file was KeybordShortcutsModal.tsx — typo in filename)
...
export default function KeyboardShortcutsModal({ isOpen, onClose }: Props) {
  // FIXED: Close on Escape key via useEffect (was missing — only backdrop click worked)
  useEffect(() => {
    if (!isOpen) return
