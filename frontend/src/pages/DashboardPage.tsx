...
const AGENTS = [
  {
    ...
    desc: 'AI Marketing OS for Indian businesses. Content, campaigns, competitor intel, creative scoring, and AI team strategy — all in one.',
    features: ['Mission Control', 'Goal Engine', 'Creative Score', 'AI Team Meeting', 'Content Generator', 'Campaign Planner'],
  ...
  },
  {
    ...
    desc: 'India-focused CA AI. GST, TDS, audit, payroll, compliance deadlines, client health scoring, and AI strategy meetings.',
    features: ['CA Command Center', 'Client Health Score', 'GST Query Bot', 'TDS Calculator', 'ITR Advisor', 'Compliance Calendar'],
  ...
  },
  {
    ...
    desc: 'WhatsApp-first support AI. Handle tickets, track CSAT, prevent churn, score responses, and run AI strategy meetings.',
    features: ['Support Command Center', 'CX Goal Planner', 'Response Quality Score', 'CS Strategy Meeting', 'Churn Risk', 'NPS Builder'],
...
const STATS = [
  ...
  { label: 'AI Features',   value: '135',  sub: 'Across all agents' },
