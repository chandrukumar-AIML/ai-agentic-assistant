...
import { screenResume, generateJD, generateOnboardingChecklist } from '../lib/api'
...
export default function HRPage() {
  ...
  return (
    <PageShell icon="👥" title="AI HR Assistant" subtitle="Feature 18 — Resume screening, JD generation, Offer letter, Onboarding checklist, BGV">
      <Tabs
        tabs={[
        ...
        <TwoCol>
          <Card>
            ...
            <Select label="Department" value={dept} onChange={setDept}
              options={['Engineering','Product','Design','Marketing','Sales','HR','Finance','Operations'].map(d => ({ label: d, value: d }))} />
            <Input label="Required Skills (comma-separated)" value={reqs} onChange={setReqs} />
